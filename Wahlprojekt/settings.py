"""
Django settings for Wahlprojekt project.
...
SECRET_KEY = 'django-insecure-1*%%yw%cf((ej^9w@(=gz7v!#6j!yew60hciv85rqfh!6u2ksl'
...
WSGI_APPLICATION = 'Wahlprojekt.wsgi.application'
